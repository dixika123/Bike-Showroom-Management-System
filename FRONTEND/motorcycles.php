...
<div class="product-details">
    ...
    <div class="price">
        <h1><?php
           // SQL query to fetch price for 'Yezdi Roadster'
$sql = "SELECT `Price` FROM `bikes` WHERE Model='Yezdi Adventure'";
$result = mysqli_query($conn, $sql);
...
if ($result) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Assign the price to a variable
        $price = $row['Price'];
        // Use $price as needed
        echo "<div class='price'><h1>Rs.".$price."</h1></div>";
    } else {
        // No rows found, handle this case (e.g., show a default message)
        echo "<div class='price'><h1>Price not available</h1></div>";
    }
} else {
    // Query failed
...
<div class="product-details">
    ...
    <div class="price" style="justify-content: baseline;">
        <h1><?php
           // SQL query to fetch price for 'Yezdi Roadster'
$sql = "SELECT `Price` FROM `bikes` WHERE Model='Yezdi Roadster'";
$result = mysqli_query($conn, $sql);
...
<div class="product-details">
    ...
    <div class="price" style="justify-content: baseline;">
        <h1><?php
           // SQL query to fetch price for 'Yezdi Roadster'
$sql = "SELECT `Price` FROM `bikes` WHERE Model='Yezdi Scrambler'";
$result = mysqli_query($conn, $sql);
...
<div class="product-details">
    ...
    <div class="price" style="justify-content: baseline;">
        <h1><?php
           // SQL query to fetch price for 'Yezdi Roadster'
$sql = "SELECT `Price` FROM `bikes` WHERE Model='Perak'";
$result = mysqli_query($conn, $sql);
...
<div class="product-details">
    ...
    <div class="price" style="justify-content: baseline;">
        <h1><?php
           // SQL query to fetch price for 'Yezdi Roadster'
$sql = "SELECT `Price` FROM `bikes` WHERE Model='Jawa 350'";
$result = mysqli_query($conn, $sql);
...
<div class="product-details">
    ...
    <div class="price" style="justify-content: baseline;">
        <h1><?php
           // SQL query to fetch price for 'Yezdi Roadster'
$sql = "SELECT `Price` FROM `bikes` WHERE Model='Jawa 42'";
$result = mysqli_query($conn, $sql);
