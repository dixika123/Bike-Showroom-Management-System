...
if(isset($_POST['regs']))
{
    ...
    $cpass=sha1(mysqli_real_escape_string($conn,$_POST['cpass']));
    $Pass=$pass;
    if(empty($fname)|| empty($lname)|| empty($email)|| empty($lic)|| empty($ph)|| empty($pass))
    {
        ...
        if(mysqli_num_rows($res)>0){
            ...
            $result=$fetch->register($fname,$lname,$email,$ph,$lic,$Pass);
...
?>
    ...
    <button id="back"><a href="FRONTEND/index.php">HOME</a></button>
    <div class="main">
        ...
        <div class="register">
            ...
            <form id="register" action="register.php" method="POST">
                ...
                <br>
                <input type="text" name="lic" id="lic" placeholder="ABC-XXXXXX-A" pattern="[A-Z]{3}-[0-9]{6}-[A-Z]"
                    title="License number must be in the format ABC-XXXXXX-A" required>
                <br><br>
